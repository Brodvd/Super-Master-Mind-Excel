...
With ThisComponent.Sheets(0)
	...
	for y= 5 to 27 step 2
	    ...
	    If .getCellByPosition(4,y).String = ThisComponent.Sheets(1).getCellRangeByName("E3").String and .getCellByPosition(5,y).String = ThisComponent.Sheets(1).getCellRangeByName("F3").String and .getCellByPosition(6,y).String = ThisComponent.Sheets(1).getCellRangeByName("G3").String and .getCellByPosition(7,y).String = ThisComponent.Sheets(1).getCellRangeByName("H3").String and .getCellByPosition(8,y).String = ThisComponent.Sheets(1).getCellRangeByName("I3").String then
			msgbox("You have won," & CHR$(13) & "Do you want to start a new game?" & CHR$(13) & "Click on NEW GAME.",,"Victory")
...
'mescolatore casuale dei colori nella soluzione (bot)'
	...
	a=int( Rnd()(0) * (7))
	Dim A1 As Variant
	A1= Array("Yellow","Red","Orange","Green","Blue","Beige","White","Black")
	dim rnd_a
	rnd_a= A1(a)
	...
	b=int( Rnd()(0) * (7))
	Dim B1 As Variant
	B1=Array("Yellow","Red","Orange","Green","Blue","Beige","White","Black")
	dim rnd_b
	rnd_b= B1(b)
	...
	c=int( Rnd()(0) * (7))
	Dim C1 As Variant
	C1=Array("Yellow","Red","Orange","Green","Blue","Beige","White","Black")
	dim rnd_c
	rnd_c= C1(c)
	...
	d=int( Rnd()(0) * (7))
	Dim D1 As Variant
	D1=Array("Yellow","Red","Orange","Green","Blue","Beige","White","Black")
	dim rnd_d
	rnd_d= D1(d)
	...
	e=int( Rnd()(0) * (7))
	Dim E1 As Variant
	E1=Array("Yellow","Red","Orange","Green","Blue","Beige","White","Black")
	dim rnd_e
	rnd_e= E1(e)
